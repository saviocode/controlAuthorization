            ...
            <form onsubmit="javascript:cadAutorizacao(this)">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="search" id="idPaciente" list="pacientes" class="form-control"
                               placeholder="Buscar Paciente" onkeyup="buscaPaciente(this)" required>
                        <datalist id="pacientes"></datalist>
                    </div>
                    <div class="form-group">
                        <label for="idProcedimento">Procedimento</label>
                        <input type="search" id="idProcedimento" list="procedimentos" class="form-control"
                               placeholder="Buscar Procedimento" onkeyup="buscaProcedimento(this)" required>
