package com.controlauthorization.entity;
...
public class Autorizacao extends Persistivel implements Serializable
{
	...
	{
		List<ControleAutorizacao> listaControleAutorizacao = new ControleAutorizacaoJPA().buscarAutorizacao(paciente, procedimento);
