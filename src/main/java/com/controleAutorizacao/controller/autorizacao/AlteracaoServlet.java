...
//import com.controleAutorizacao.dao.PacienteJDBC;
//import com.controleAutorizacao.dao.ProcedimentoJDBC;
...
//            Autorizacao autorizacao = new AutorizacaoJDBC().buscarPorId(String.valueOf(idAutorizacao));
//            autorizacao.setProcedimento(procedimento);
//            autorizacao.setPaciente(paciente);
//
//            if (new AutorizacaoJDBC().atualiza(autorizacao)) {
